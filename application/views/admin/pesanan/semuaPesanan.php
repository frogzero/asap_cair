                       ...
                       $i++; ?>
                                     ...
                                     <tr>
                                        ...
                                        <td>Rp. <?= number_format($row->totalBayar,0,',','.') ?></td>
                                         <td><?=($row->status) ?></td>
                                         <td><a href="<?=site_url()?>/admin/pesanan/download_file/<?=$row->download_gambar?>"><?=($row->download_gambar) ?></a></td>
                                        <td><?=($row->tanggalPesan) ?></td>                                        
                                        <th>
                                        
                                        <a href="<?php echo site_url(); ?>/admin/pesanan/hapusPesanan/<?=$row->idPesan ?>" onclick="return confirm('Yakin Hapus ?')">Hapus</a>|
