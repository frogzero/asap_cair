...
<table width="794"  border-style="solid" align="center">
  <tr>
    <td height="888" valign="top"><table width="100%" border="0">
      <tr>
         <td height="86" colspan="2" align="center"><p>Mitra</p>
          <p>Murangan 7 RT 02 RW 22 Triharjo Sleman Yogyakarta<br />
          </p>
          <hr /></td>
        </tr>
      <tr>
    ...
    border-collapse: collapse;" >
         ...
         <tr>
          ...
          <tr>
            <td>Total bayar + Ongkir</td>
            <td>Rp. <?=number_format($pesanan->totalBayar,0,',','.')?></td>
          </tr>
