...
<div class="col-md-7 single-top-in">
					...
					<div class="col-md-12">
						<div class="col-md-6">
			<?php $i=0;
            $sql="SELECT * FROM stok WHERE id_produk='$row->id_produk' ";
            $query = $this->db->query($sql); ?>  
            <?php foreach ($query->result() as $data) {?>
			<label for="exampleInputEmail1">Stock : <?=$data->stok?></label><br><br>
			<?php } ?>
		<label for="exampleInputEmail1">Jumlah Pesan : </label><input type="number" name="jumlah" class="form-group">
		</div>
		<div class="col-md-6">
		<br>
		<br>
