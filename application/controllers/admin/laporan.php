...
class Laporan extends CI_Controller {
	...
	public function laporan_pesanan_per_periode()
	{
		ob_start();
		$tgl_awal =  $this->input->post('tgl_awal');
		$tgl_akhir =  $this->input->post('tgl_akhir');
		$data['pesanan'] = $this->model_laporan->laporanPesananPerPeriode($tgl_awal,$tgl_akhir);
		$this->load->view('admin/laporan/laporanPesanan', $data);
		$html = ob_get_contents();
		ob_end_clean();
	...
	public function laporan_detail_pesanan_per_periode()
	{
		ob_start();
		$tgl_awal =  $this->input->post('tgl_awal');
		$tgl_akhir =  $this->input->post('tgl_akhir');
		$data['pesanan'] = $this->model_laporan->laporanDetailPesananPerPeriode($tgl_awal,$tgl_akhir);
		$this->load->view('admin/laporan/laporanDetailPesanan', $data);
		$html = ob_get_contents();
		ob_end_clean();
